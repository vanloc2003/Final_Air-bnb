    ...
    <div className="container mx-auto px-12 py-12">
      ...
      <div className="relative w-full mb-10">
        <img
          ...
          className="w-70% h-full object-cover rounded-xl shadow-2xl cursor-pointer hover:opacity-90 transition"
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="text-gray-700 text-sm">
            <p>- Tự nhận phòng Tự nhận phòng bằng khóa thông minh.</p>
            <p>- Dinh Long là Chủ nhà siêu cấp Chủ nhà siêu cấp là những chủ nhà có kinh nghiệm, được đánh giá cao và <br /> <span className="ml-2.5">là những người cam kết mang lại quãng thời gian ở tuyệt vời cho khách.</span></p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              {[
                ...
                item.available ? (
                  <div
                    key={index}
                    className="flex items-center gap-3 text-blue-700 cursor-pointer"
                  >
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <span>
                  Toàn bộ nhà — Bạn sẽ có chung cư cao cấp cho riêng mình.
                </span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <span>
                  Vệ sinh tăng cường — Chủ nhà cam kết quy trình 5 bước của
                  Airbnb.
                </span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <span>
                  Phong là Chủ nhà siêu cấp — Được đánh giá cao và tận tâm phục
                  vụ khách.
                </span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
        ...
        {/* Bảng giá */}
        <div className="w-full md:w-1/3 bg-stone-100 p-8 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300">
